...
'     \/   |_|       \/  \/  /_/ |_|\____/_/  /_/    |______/_/\_\__,_|_| |_| |_| .__/|_|\___|    |_|\__,_|_.__/|_|\___|   V1.7
'                                                                               | |
'                                                                               |_|
...
'1.6.2 apophis - Updated kicker logic to be more robust.
'1.6.3 apophis - Set DTMass and STMass to 0.1. Updated zCol_Targets and zCol_DropTarget materials to align with Example Table.
'1.6.4 apophis - Updated slingshot correction curves
...
Sub KickerUpperLeft(Enable)							'Solonoid name associated with kicker.
    If Enable then
		If Not IsEmpty(KickerBall37) Then
...
Sub ScoopKicker(Enable)
    If Enable then
		If Not IsEmpty(KickerBall38) Then
...
Sub KickerUpperRight(Enable)
    If Enable then
		If Not IsEmpty(KickerBall39) Then
			KickBall KickerBall39, 23, 0, 50, 10
			SoundSaucerKick 1, sw39
		Else
			SoundSaucerKick 0, sw39
		End If
	End If
End Sub
